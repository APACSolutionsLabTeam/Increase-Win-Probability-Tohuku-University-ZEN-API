...
if runpy:
    ...
    inputfile = r'C:\Users\ZSPANIYA\Desktop\Projects\APEERModules\PythonScripts\oad.py'
    oadcommandlist = tcp.create_oadlist_frompy(inputfile, extension='.py')

if runczmac:
    # define OAD macro
    inputfile = r'C:\Users\ZSPANIYA\Documents\Carl Zeiss\ZEN\Documents\Macros\oad.czmac'
    # convert it to text
